...
public class CSimplificadoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"CHAR", "FLOAT", "INT", "BOOLEAN", "VOID", "MAIN", "FUNC", "IF", "ELSE", 
			"WHILE", "RETURN", "SCANF", "PRINTLN", "ADD", "SUB", "MUL", "DIV", "MOD", 
			"OR", "AND", "EQ", "NE", "LT", "GT", "LE", "GE", "NOT", "ASSIGN", "SEMICOLON", 
			"COMMA", "LPAREN", "RPAREN", "LBRACKET", "RBRACKET", "LBRACE", "RBRACE", 
			"ID", "NUM_INT", "NUM_DEC", "TEXTO", "WS", "COMENTARIO", "COMENTARIO_LINHA"
		};
	}
